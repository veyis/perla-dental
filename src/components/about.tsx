        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              ...
              <p className="text-sm font-semibold uppercase tracking-wider text-text-muted">Years Experience</p>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            <p className="text-lg text-text-muted mb-10 leading-relaxed">
              Located in the heart of Lara, Antalya, we provide a world-class dental experience that combines advanced Turkish hospitality with cutting-edge German and American medical standards. 
              Our mission is to make your "Dental Holiday" as seamless and comfortable as possible.
            </p>
