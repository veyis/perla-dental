...
export function Hero({ title, subtitle, status, locale }: HeroProps) {
  ...
  return (
    <section
      ref={containerRef}
      className="relative min-h-screen flex items-center pt-24 pb-20 overflow-hidden bg-[#fafafa]"
    >
        ...
        <div className="grid lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-7 relative z-10">
            ...
            >
              ...
              <span className="text-[11px] font-bold uppercase tracking-widest text-text-muted ml-1">
            ...
            >
              ...
              <div className="flex items-center gap-5 p-5 pr-8 rounded-[2rem] glass border border-white/50 shadow-premium hover:shadow-2xl transition-all duration-500 cursor-pointer group">
                ...
                <div>
                  <p className="font-bold text-primary group-hover:translate-x-1 transition-transform">
                    AI Health Concierge
                  </p>
            ...
            <motion.div style={{ y: y1 }} className="relative aspect-[4/5] w-full">
              ...
              <div className="relative h-full w-full rounded-[60px] overflow-hidden shadow-[0_40px_100px_rgba(0,0,0,0.15)] group">
                ...
                <div className="absolute bottom-10 left-10 text-white">
                  <p className="text-xs font-bold uppercase tracking-[0.2em] mb-1 opacity-80">
                    Antalya, Turkey
                  </p>
              ...
              >
                ...
                <h3 className="text-xl font-heading font-bold mb-3">Digital Smile Design</h3>
                <p className="text-sm text-text-muted leading-relaxed">
                  3Shape intraoral scanner and CAD-CAM technology for perfect, predictable results.
                </p>
