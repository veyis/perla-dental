...
const services = [
  ...
  },
  {
    ...
    description: 'Experience painless treatments with our state-of-the-art digital scanners and 3D imaging.',
    icon: Shield,
    image: '/images/tech.png'
  },
  {
    title: 'Preventive Care',
    description: 'Maintain a lifetime of oral health with comprehensive cleanings and personalized dental plans.',
    icon: Clock,
    ...
    <section id="services" className="py-24 bg-accent/10">
      <div className="container mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            World-Class Care, <br/><span className="text-primary">Tailored to You</span>
          </motion.h2>
          <p className="text-text-muted text-lg">
            We combine art and science to create beautiful smiles and ensure optimal oral health using the most advanced techniques available today.
          </p>
        </div>
          ...
          {services.map((service, index) => (
            ...
            >
              <div className="relative h-48 w-full mb-8 rounded-2xl overflow-hidden">
                <Image src={service.image} alt={service.title} fill sizes="(max-width: 768px) 100vw, 33vw" className="object-cover group-hover:scale-110 transition-transform duration-700" />
